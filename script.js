/* ═══════════════════════════════════════════════
   INTERVIEWIQ — script.js
   ═══════════════════════════════════════════════ */

// ─────────────────────────────────────────────────
//  EXPANDED QUESTION BANK  (15 per role per difficulty)
// ─────────────────────────────────────────────────
const QUESTION_BANK = {
  "Frontend Developer": {
    Easy: [
      ...
      { q: "What is the CSS box model?", topic: "CSS", kw: ["content","padding","border","margin","layout","width","height","box-sizing"] },
      ...
      { q: "What is the DOM in JavaScript?", topic: "JavaScript", kw: ["document","object","model","html","tree","nodes","manipulation","api"] },
      ...
      { q: "What is the purpose of the `<meta>` tag?", topic: "HTML", kw: ["metadata","charset","viewport","description","seo","browser","encoding"] },
      { q: "What is the difference between inline and block elements?", topic: "HTML/CSS", kw: ["inline","block","flow","width","height","span","div","display"] },
      { q: "What is a CSS class vs an ID?", topic: "CSS", kw: ["class","id","reusable","unique","specificity","selector","multiple","single"] },
      { q: "What does `position: relative` do in CSS?", topic: "CSS", kw: ["relative","offset","top","left","parent","normal flow","position","layout"] },
      { q: "What is an event listener in JavaScript?", topic: "JavaScript", kw: ["event","listener","click","function","handler","addeventlistener","trigger","dom"] },
      { q: "What is the difference between `null` and `undefined`?", topic: "JavaScript", kw: ["null","undefined","empty","assigned","value","type","intentional","default"] },
    ...
    Medium: [
      ...
      { q: "Explain the virtual DOM in React.", topic: "React", kw: ["virtual","real","diff","reconciliation","performance","update","render","react","dom"] },
      ...
      { q: "What is prop drilling in React and how do you avoid it?", topic: "React", kw: ["prop","drilling","context","redux","state","parent","child","pass","avoid"] },
      { q: "What is the difference between `call`, `apply`, and `bind`?", topic: "JavaScript", kw: ["call","apply","bind","this","context","arguments","array","invoke","function"] },
      { q: "What are CSS custom properties (variables)?", topic: "CSS", kw: ["custom property","variable","--","var()","reuse","theme","cascade","inherit","value"] },
      { q: "What is the purpose of `useEffect` in React?", topic: "React", kw: ["useEffect","side effect","lifecycle","cleanup","dependency","mount","unmount","fetch","update"] },
      { q: "How does the JavaScript prototype chain work?", topic: "OOP JS", kw: ["prototype","chain","inherit","object","property","lookup","__proto__","constructor","method"] },
    ...
    Hard: [
      ...
      { q: "Describe code splitting and lazy loading in a React app.", topic: "Optimization", kw: ["import","dynamic","lazy","suspense","chunk","bundle","webpack","performance","route"] },
      ...
      { q: "Explain `useMemo` and `useCallback` in React.", topic: "React", kw: ["cache","memoize","usememo","usecallback","render","expensive","dependency","performance","reference"] },
      { q: "What is the Reconciliation algorithm in React?", topic: "React Internals", kw: ["reconciliation","fiber","diff","tree","key","update","virtual dom","rerender","algorithm"] },
      { q: "What is a Service Worker and how does it enable PWAs?", topic: "PWA", kw: ["service worker","cache","offline","pwa","fetch","install","activate","background","push"] },
      { q: "Explain memory leaks in JavaScript and how to prevent them.", topic: "Performance", kw: ["memory leak","garbage collection","closure","listener","reference","detach","weak","heap","prevent"] },
      { q: "What is the difference between microtasks and macrotasks?", topic: "JS Advanced", kw: ["microtask","macrotask","promise","settimeout","queue","event loop","order","execution","priority"] },
      { q: "How would you implement infinite scrolling efficiently?", topic: "Performance", kw: ["intersection observer","scroll","lazy load","pagination","virtual","dom","performance","threshold","api"] },
    ]
  },
  "Backend Developer": {
    Easy: [
      ...
      { q: "What is the difference between GET and POST?", topic: "HTTP", kw: ["get","retrieve","post","send","body","url","idempotent","request","data"] },
      ...
      { q: "What is a primary key in a database?", topic: "Databases", kw: ["primary key","unique","identifier","row","table","constraint","auto increment","index","reference"] },
      { q: "What is the difference between a library and a framework?", topic: "Concepts", kw: ["library","framework","inversion","control","tool","reuse","structure","opinionated","call"] },
      ...
      { q: "What is the difference between synchronous and asynchronous code?", topic: "Concepts", kw: ["synchronous","blocking","asynchronous","non-blocking","callback","promise","await","concurrent","thread"] },
      { q: "What is a foreign key?", topic: "Databases", kw: ["foreign key","reference","relation","table","integrity","constraint","join","parent","child"] },
      { q: "What is npm?", topic: "Node.js", kw: ["npm","package","manager","node","install","dependency","registry","module","version"] },
    ...
    Medium: [
      ...
      { q: "What is an ORM?", topic: "Databases", kw: ["orm","object","relational","mapping","model","query","abstraction","sequelize","typeorm","database"] },
      { q: "What is the difference between horizontal and vertical scaling?", topic: "Architecture", kw: ["horizontal","vertical","scale","server","load","resource","node","shard","replicate"] },
      { q: "What is database indexing?", topic: "Databases", kw: ["index","btree","query","performance","lookup","clustered","non-clustered","disk","write","read"] },
      { q: "How does session management work?", topic: "Security", kw: ["session","cookie","server","store","id","expire","stateful","http","client","redis"] },
      { q: "What is a RESTful resource and how do you design routes?", topic: "API Design", kw: ["resource","route","noun","verb","plural","nested","endpoint","http","method","uri"] },
    ...
    Hard: [
      ...
      { q: "Describe event-driven architecture and message queues.", topic: "Architecture", kw: ["event","queue","publish","subscribe","kafka","rabbitmq","async","decouple","message","producer"] },
      { q: "How would you design a URL shortener system?", topic: "System Design", kw: ["hash","redirect","database","cache","collision","base62","unique","short","mapping","scale"] },
      { q: "Explain database sharding.", topic: "Distributed Systems", kw: ["shard","partition","horizontal","key","range","hash","distribute","scale","node","rebalance"] },
      { q: "What is eventual consistency?", topic: "Distributed Systems", kw: ["eventual","consistency","replicate","sync","delay","distributed","partition","available","conflict","resolve"] },
      { q: "How would you implement a distributed cache?", topic: "System Design", kw: ["cache","distributed","redis","cluster","eviction","ttl","invalidate","consistency","node","replicate"] },
      { q: "What is a circuit breaker pattern?", topic: "Architecture", kw: ["circuit breaker","failure","open","closed","half-open","retry","timeout","resilience","microservice","fallback"] },
      { q: "How do you prevent SQL injection?", topic: "Security", kw: ["sql injection","parameterize","prepared statement","escape","validate","orm","whitelist","input","query","malicious"] },
    ]
  },
  "AI/ML Engineer": {
    Easy: [
      ...
      { q: "What does feature engineering mean?", topic: "Data Prep", kw: ["feature","variable","transform","encode","normalize","select","extract","input","domain"] },
      ...
      { q: "What is classification vs regression?", topic: "ML Basics", kw: ["classification","category","regression","continuous","output","predict","label","value","model"] },
      { q: "What is an activation function?", topic: "Deep Learning", kw: ["activation","relu","sigmoid","tanh","nonlinear","output","neuron","layer","squash"] },
      { q: "What is a dataset bias?", topic: "Data", kw: ["bias","dataset","representation","skew","fairness","sample","training","imbalance","distribution"] },
      ...
      { q: "What is k-nearest neighbors (KNN)?", topic: "Algorithms", kw: ["knn","k","nearest","neighbor","distance","classify","vote","lazy","instance","euclidean"] },
      { q: "What is a decision tree?", topic: "Algorithms", kw: ["decision tree","node","split","branch","leaf","feature","threshold","gini","entropy","impurity"] },
      ...
      { q: "What is the difference between a model and an algorithm?", topic: "ML Basics", kw: ["algorithm","model","training","learn","parameters","procedure","output","fit","pattern"] },
    ...
    Medium: [
      ...
      { q: "What is the vanishing gradient problem?", topic: "Deep Learning", kw: ["vanishing","gradient","backprop","deep","relu","sigmoid","explode","layer","training","rnn"] },
      { q: "What is an ensemble method?", topic: "Algorithms", kw: ["ensemble","bagging","boosting","random forest","xgboost","combine","model","variance","bias","accuracy"] },
      { q: "What is dimensionality reduction?", topic: "Data", kw: ["dimensionality","pca","reduction","feature","curse","compress","variance","components","tsne","umap"] },
      { q: "How does the Random Forest algorithm work?", topic: "Algorithms", kw: ["random forest","tree","bagging","subset","feature","vote","ensemble","bootstrap","overfitting","robust"] },
      { q: "What is the ROC-AUC curve?", topic: "Evaluation", kw: ["roc","auc","curve","threshold","true positive rate","false positive rate","classify","performance","tradeoff"] },
    ],
    Hard: [
      ...
      { q: "Explain GANs and how they are trained.", topic: "Generative AI", kw: ["generator","discriminator","adversarial","gan","loss","fake","real","nash","equilibrium","training"] },
      { q: "What is the RLHF technique used in LLMs?", topic: "LLMs", kw: ["rlhf","reinforcement","human","feedback","reward","policy","fine-tune","alignment","preference","ppo"] },
      { q: "What are embeddings and why are they used?", topic: "NLP", kw: ["embedding","vector","representation","word2vec","semantic","dimension","space","similarity","encode","dense"] },
      { q: "How does a convolutional neural network (CNN) work?", topic: "Deep Learning", kw: ["cnn","convolve","kernel","filter","pooling","feature map","stride","padding","image","activation"] },
      { q: "What is the bias-variance tradeoff?", topic: "Theory", kw: ["bias","variance","tradeoff","underfit","overfit","complexity","error","generalize","decompose","noise"] },
      { q: "What is federated learning?", topic: "Advanced ML", kw: ["federated","distributed","privacy","local","model","aggregate","client","server","gradient","edge"] },
    ]
  },
  "HR Manager": {
    Easy: [
      { q: "Tell me about yourself and your HR background.", topic: "Introduction", kw: ["experience","recruitment","onboarding","employee","policies","communication","team","organization","management"] },
      ...
      { q: "What is an employee handbook?", topic: "HR Basics", kw: ["handbook","policy","procedure","code","conduct","guide","rules","benefit","expectation","document"] },
      { q: "What is the difference between a job description and a job specification?", topic: "Recruitment", kw: ["job description","duties","specification","skills","qualification","requirement","role","responsibility","criteria"] },
      { q: "What is payroll?", topic: "Compensation", kw: ["payroll","salary","wage","deduction","tax","process","period","employee","calculate","compliance"] },
      { q: "What is an exit interview?", topic: "Retention", kw: ["exit","interview","leaving","feedback","reason","improve","culture","retention","turnover","insight"] },
      { q: "What is workplace harassment?", topic: "Compliance", kw: ["harassment","unwanted","hostile","policy","report","investigate","zero tolerance","behavior","protect","law"] },
    ],
    Medium: [
      ...
      { q: "Explain employee engagement and how you measure it.", topic: "Engagement", kw: ["engagement","survey","pulse","satisfaction","motivation","productivity","culture","recognition","feedback","morale"] },
      ...
      { q: "How do you manage remote teams effectively?", topic: "Remote Work", kw: ["remote","communication","async","tool","check-in","trust","output","culture","timezone","engage"] },
      { q: "What is succession planning?", topic: "Talent Management", kw: ["succession","planning","pipeline","leadership","identify","develop","critical","role","replace","future"] },
      { q: "How do you handle poor performance?", topic: "Performance", kw: ["pip","performance","improvement","plan","document","coach","feedback","warning","terminate","support"] },
      { q: "What is an HRIS and how do you use it?", topic: "HR Technology", kw: ["hris","system","data","employee","automate","report","workflow","integrate","track","portal"] },
      { q: "How do you design a compensation structure?", topic: "Compensation", kw: ["band","grade","benchmark","market","equity","range","role","level","salary","structure"] },
    ],
    Hard: [
  ...
  "Data Analyst": {
    Easy: [
      ...
      { q: "What is the difference between qualitative and quantitative data?", topic: "Data Basics", kw: ["qualitative","descriptive","quantitative","numerical","measure","category","type","survey","count"] },
      { q: "What is an outlier in data?", topic: "Statistics", kw: ["outlier","anomaly","extreme","deviation","standard","boxplot","remove","impact","distribution"] },
      { q: "What is a bar chart used for?", topic: "Visualization", kw: ["bar chart","compare","category","count","frequency","height","axis","label","discrete"] },
      { q: "What is a JOIN in SQL?", topic: "SQL", kw: ["join","inner","outer","left","right","combine","table","key","match","relation"] },
      { q: "What is data granularity?", topic: "Data Concepts", kw: ["granularity","level","detail","row","aggregate","fine","coarse","transaction","summary"] },
    ],
    Medium: [
      ...
      { q: "Describe data visualization best practices.", topic: "Visualization", kw: ["chart","bar","line","pie","axis","label","color","audience","insight","storytelling"] },
      ...
      { q: "What is the difference between a fact table and a dimension table?", topic: "Data Warehousing", kw: ["fact","dimension","star schema","measure","key","foreign","grain","warehouse","olap"] },
      { q: "How do you use GROUP BY in SQL?", topic: "SQL", kw: ["group by","aggregate","count","sum","avg","having","filter","column","query","result"] },
      { q: "What is a z-score?", topic: "Statistics", kw: ["z-score","standard","deviation","mean","normalize","outlier","normal","distribution","distance","measure"] },
      { q: "What is data normalization in databases?", topic: "Databases", kw: ["normalization","1nf","2nf","3nf","redundancy","dependency","table","relation","key","integrity"] },
      { q: "How do you present findings to non-technical stakeholders?", topic: "Communication", kw: ["story","insight","visual","simple","context","action","impact","audience","clarity","executive"] },
    ],
    Hard: [
  ...
  "Cybersecurity": {
    Easy: [
      ...
      { q: "What is two-factor authentication (2FA)?", topic: "Authentication", kw: ["two-factor","2fa","otp","sms","authenticator","code","second","verify","login","secure"] },
      { q: "What is a VPN?", topic: "Network Security", kw: ["vpn","virtual","private","network","encrypt","tunnel","ip","remote","secure","traffic"] },
      { q: "What is social engineering?", topic: "Threats", kw: ["social engineering","manipulate","human","trick","pretexting","phishing","trust","psychology","deceive","attack"] },
      { q: "What is patch management?", topic: "Vulnerability", kw: ["patch","update","vulnerability","software","fix","exploit","schedule","apply","security","system"] },
      { q: "What is the difference between HTTP and HTTPS?", topic: "Web Security", kw: ["http","https","ssl","tls","encrypt","certificate","secure","protocol","data","transport"] },
    ],
    Medium: [
      ...
      { q: "What is SIEM and how is it used?", topic: "Monitoring", kw: ["siem","log","event","correlate","alert","monitor","incident","threat","aggregate","response"] },
      { q: "What is privilege escalation?", topic: "Attacks", kw: ["privilege","escalation","admin","root","exploit","permission","vertical","horizontal","gain","access"] },
      { q: "How does DNS spoofing work?", topic: "Network Attacks", kw: ["dns","spoof","poison","cache","redirect","domain","ip","fake","resolve","attacker"] },
      { q: "What is a buffer overflow attack?", topic: "Attacks", kw: ["buffer","overflow","memory","stack","heap","exploit","shellcode","input","validation","crash"] },
      { q: "What is the difference between black box and white box testing?", topic: "Pen Testing", kw: ["black box","white box","knowledge","internal","external","source","access","test","gray","methodology"] },
    ],
    Hard: [
  ...
  "DevOps Engineer": {
    Easy: [
      ...
      { q: "What is a load balancer?", topic: "Networking", kw: ["load balancer","distribute","traffic","server","health","round robin","scale","availability","request","route"] },
      { q: "What is Kubernetes?", topic: "Orchestration", kw: ["kubernetes","k8s","container","orchestrate","pod","deployment","service","scale","cluster","node"] },
      { q: "What is a deployment pipeline?", topic: "CI/CD", kw: ["pipeline","stage","build","test","deploy","automate","trigger","artifact","gate","environment"] },
      { q: "What is monitoring in DevOps?", topic: "Observability", kw: ["monitor","metric","alert","log","dashboard","performance","uptime","health","threshold","observe"] },
      { q: "What is the difference between staging and production environments?", topic: "Environments", kw: ["staging","production","test","live","mirror","deploy","validate","environment","release","risk"] },
    ],
    Medium: [
  ...
  "Product Manager": {
    Easy: [
      ...
      { q: "What is the difference between a product and a project manager?", topic: "PM Basics", kw: ["product","project","strategy","execution","ongoing","deadline","value","outcome","permanent","temporary"] },
      ...
      { q: "What is a KPI vs a metric?", topic: "Metrics", kw: ["kpi","metric","key","performance","indicator","measure","goal","success","track","outcome"] },
      { q: "What is customer discovery?", topic: "Research", kw: ["customer","discovery","interview","problem","validate","insight","research","user","need","assumption"] },
      { q: "What is a product backlog?", topic: "Agile", kw: ["backlog","item","priority","user story","epic","feature","refine","groom","order","estimate"] },
      { q: "What is a go-to-market strategy?", topic: "Strategy", kw: ["go-to-market","launch","audience","channel","message","pricing","positioning","sales","market","plan"] },
    ],
    Medium: [
...
function setSession(username)    { localStorage.setItem('iq_session', username); }
...
// Simple obfuscation (not real hashing — client-side only)
...
function handleLogin() {
  ...
  if (users[username].password !== obfuscate(password)) { errEl.textContent = 'Incorrect password.'; return; }
...
function loginSuccess(username) {
  ...
  document.getElementById('topBarUser').textContent = `👋 Hi, ${username}`;

  refreshStreakBadge(username);
  showScreen('setup-screen');
  populateSetupStats(username);
...
function refreshStreakBadge(username) {
  const data = getUserData(username);
...
//  SETUP STATS
// ─────────────────────────────────────────────────
function populateSetupStats(username) {
  const data    = getUserData(username);
  const history = data.history || [];
  const streak  = data.streak  || 0;
  const count   = history.length;
  const avg     = count > 0
    ? Math.round(history.reduce((s, h) => s + h.pct, 0) / count)
    : null;
...
//  HISTORY
// ─────────────────────────────────────────────────
function populateHistory(username) {
  const data    = getUserData(username);
  const history = (data.history || []).slice(-5).reverse(); // last 5, newest first
...
// ─────────────────────────────────────────────────
//  SETUP — ROLE / DIFFICULTY / COUNT SELECTION
// ─────────────────────────────────────────────────
...
function startInterview() {
  ...
  // If pool is smaller than requested count, duplicate and shuffle
  let extended = [...pool];
  ...
  document.getElementById('interviewUserTag').textContent = `👋 ${state.currentUser || 'User'}`;
...
function loadQuestion() {
  ...
  document.getElementById('progressFill').style.width =
    (state.qi / state.questions.length * 100) + '%';

  const card = document.getElementById('questionCard');
  card.style.animation = 'none';
  requestAnimationFrame(() => { card.style.animation = 'slideIn 0.35s ease'; });

  startTimer(TIMER_MAX);
}

// ─────────────────────────────────────────────────
//  TIMER  —  2 minutes, MM:SS
// ─────────────────────────────────────────────────
...
document.getElementById('historyBtn').addEventListener('click', () => {
  goToSetup();
  setTimeout(() => populateHistory(state.currentUser), 100);
});
...
function showReport() {
  ...
  let verdict, sub;
  if      (pct >= 80) { verdict = '🏆 Outstanding';      sub = `You're well-prepared for the ${state.role} role.`; }
  ...
  else                { verdict = '🔁 Keep Practicing';   sub = `Review key topics for ${state.role}. Consistent practice helps!`; }
  ...
  state.answers.forEach((a, i) => {
    ...
    const label = a.q.length > 60 ? a.q.slice(0, 60) + '…' : a.q;
    bl.innerHTML += `
  ...
  if (allMissed.length > 0) {
    ...
    missedEl.innerHTML = allMissed.map(kw =>
      `<span class="kw-tag kw-miss">${kw}</span>`).join('');
  } else {
  ...
  // Refresh streak badge and stats after saving
  if (state.currentUser) {
    refreshStreakBadge(state.currentUser);
  }
}
...
function buildChart(answers) {
  ...
  const colors = answers.map(a =>
    a.tier === 'good' ? 'rgba(109,250,188,0.8)'
    : a.tier === 'avg'  ? 'rgba(250,217,109,0.8)'
    :                     'rgba(250,109,143,0.8)'
  );
  ...
  window._chartInst = new Chart(canvas, {
    ...
    data: {
      ...
      datasets: [{ data: pcts, backgroundColor: colors, borderRadius: 6, borderSkipped: false }]
    },
    options: {
      responsive: true,
...
// ─────────────────────────────────────────────────
//  INIT — check for saved session & theme
// ─────────────────────────────────────────────────
(function init() {
  // Theme
  const savedTheme = localStorage.getItem('iq_theme') || 'dark';
  ...
  if (savedUser && getUserData(savedUser)) {
    ...
    document.getElementById('topBar').style.display = 'flex';
    document.getElementById('topBarUser').textContent = `👋 Hi, ${savedUser}`;
    updateStreak(savedUser);
    refreshStreakBadge(savedUser);
    showScreen('setup-screen');
    populateSetupStats(savedUser);
    populateHistory(savedUser);
  }
})();